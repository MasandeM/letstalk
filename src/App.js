...
function FilterableTalkTable(){
    ...
    return(
            <div className="ais-InstantSearch">
                ...
                <p >
                   Security conferences are one of the best sources for keeping up to-date on industry's trends, but the sheer number of talks made in any given year, makes it difficult to find those that you might be interested in. 
